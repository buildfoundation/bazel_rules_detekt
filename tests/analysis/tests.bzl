...
def _action_full_contents_test_impl(ctx):
    ...
    expected_arguments = _expand_paths(env.ctx, [
        ...
        "--classpath",
        ",".join([
            "{{output_dir}}/external/rules_detekt_dependencies/v1/https/repo1.maven.org/maven2/org/jetbrains/kotlin/kotlin-stdlib/1.5.31/header_kotlin-stdlib-1.5.31.jar",
            ...
            "{{output_dir}}/external/rules_detekt_dependencies/v1/https/repo1.maven.org/maven2/org/jetbrains/kotlin/kotlin-stdlib-common/1.5.31/header_kotlin-stdlib-common-1.5.31.jar",
        ]),
        "--language-version",
        "1.5",
        "--jvm-target",
